...
void swap1(int n1, int n2)
{
  int temp = n1;
  n1 = n2;
  n2 = temp;   // This swap will not affect or change the actual arguments, and n1 and n2 will be destroyed after the function ends
}
...
void swap2(int& n1, int& n2)
{
  int temp = n1;
  n1 = n2;
  n2 = temp;   // This swap will affect the actual parameters
}
...
int main()
{
  ...
  int* p1 = &num1;
  int* p2 = &num2;   // Store address of num1 and num2
